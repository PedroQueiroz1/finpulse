package com.finpulse.notes.aspect;
...
public class LoggingAspect {
    ...
    private static final String[] SENSITIVE_PARAMS = {"password", "senha", "token", "secret", "key", "credential"};

    @Around("execution(* com.finpulse.notes.controller.*.*(..)) || execution(* com.finpulse.notes.service.*.*(..))")
